...
public class biologisistempencernaanvideo extends AppCompatActivity {
    Button unduh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biologisistempencernaanvideo);
        ...
        unduh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                request.setDestinationUri(Uri.fromFile(new File(biologisistempencernaanvideo.this.getExternalFilesDir
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(biologisistempencernaanvideo.this, biolist.class));
            }
        });
        surfaceView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(biologisistempencernaanvideo.this, surfaceview2.class));
            }
        });
    }
}