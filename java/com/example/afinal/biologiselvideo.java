...
public class biologiselvideo extends AppCompatActivity {
    Button unduh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biologiselvideo);
        ...
        unduh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                request.setDestinationUri(Uri.fromFile(new File(biologiselvideo.this.getExternalFilesDir
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(biologiselvideo.this, biolist.class));
            }
        });
        surfaceView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(biologiselvideo.this, surfaceview2.class));
            }
        });
    }
}